...
h+"');})()"}}catch(l){K(this.getVersionParamName(),this.getVersion(),"DvFrame: "+encodeURIComponent(l),!1)}return!0};window.debugScript&&(!window.minDebugVersion||10>=window.minDebugVersion)&&(window.DvVerify=M,window.createRequest=this.createRequest);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"106"}};
